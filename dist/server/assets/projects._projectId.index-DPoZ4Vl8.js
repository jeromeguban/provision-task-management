import { a as deleteTask, c as getTasksByProject, i as deleteComment, l as moveTask, n as addComment, o as getProjectMembers, r as createTask, s as getTask, t as Route, u as updateTask } from "./projects._projectId.index-BP0NbEQz.js";
...
import { Calendar, Check, CheckCircle2, ChevronDown, ChevronRight, Clock3, GripVertical, Kanban, List, ListTodo, MessageSquare, Plus, RefreshCcw, Search, Send, Trash2, UserRound, X, Zap } from "lucide-react";
import { createPortal } from "react-dom";
//#region src/components/tasks/TaskCard.tsx
...
//#endregion
//#region src/components/tasks/TaskForm.tsx
...
function TaskForm({ projectId, initialData, onSubmit, onCancel, submitLabel = "Create Task" }) {
	...
	const currentStatus = STATUS_OPTIONS$2.find((s) => s.value === status) ?? STATUS_OPTIONS$2[1];
	const currentPriority = PRIORITY_OPTIONS$2.find((p) => p.value === priority) ?? PRIORITY_OPTIONS$2[4];
					...
					/* @__PURE__ */ jsx(PillDropdown, {
						trigger: /* @__PURE__ */ jsxs("div", {
							...
							children: [currentAssignee ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Avatar, {
								...
								children: currentAssignee.user.fullName?.split(" ")[0] ?? currentAssignee.user.email
						...
						children: (close) => /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs(DropdownItem$2, {
						...
						}), members.map((m) => /* @__PURE__ */ jsxs(DropdownItem$2, {
							...
							children: [/* @__PURE__ */ jsx(Avatar, {
								...
								size: "sm"
							}), /* @__PURE__ */ jsx("span", { children: m.user.fullName ?? m.user.email })]
						}, m.userId))] })
					})
				]
			}),
...
//#endregion
//#region src/components/tasks/TaskDetail.tsx
...
function TaskDetail({ task, projectId, onUpdate, onFieldUpdate, onDelete, onStatusChange, onClose }) {
	...
	const currentStatus = STATUS_OPTIONS$1.find((s) => s.value === task.status) ?? STATUS_OPTIONS$1[0];
	const currentPriority = PRIORITY_OPTIONS$1.find((p) => p.value === task.priority) ?? PRIORITY_OPTIONS$1[4];
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [
											/* @__PURE__ */ jsx("span", {
												...
												children: c.author.fullName ?? c.author.email
											}),
											/* @__PURE__ */ jsx("span", {
					...
					children: /* @__PURE__ */ jsx(PropDropdown, {
						trigger: /* @__PURE__ */ jsx("div", {
							...
							children: task.assignee ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Avatar, {
								...
								children: task.assignee.fullName ?? task.assignee.email
						...
						}), members.map((m) => /* @__PURE__ */ jsxs(DropdownItem$1, {
				...
				/* @__PURE__ */ jsx(PropRow, {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(Avatar, {
							...
							size: "sm"
						}), /* @__PURE__ */ jsx("span", { children: task.creator.fullName ?? task.creator.email })]
					})
				}),
				/* @__PURE__ */ jsx(PropRow, {
					label: "Created",
...
//#endregion
//#region src/components/tasks/TaskBoard.tsx
var COLUMNS = [
	{
		status: "BACKLOG",
		label: "Backlog",
...
function TaskBoard({ projectId, tasks, onRefresh, onTasksChange, dragDisabled = false }) {
	...
	const handleCreate = async (data) => {
		await createTask({ data: {
			...
			assigneeId: data.assigneeId ?? void 0
		} });
	...
	const handleUpdate = async (data) => {
		...
		setSelectedTask((cur) => cur?.id === updated.id ? {
			...cur,
			title: updated.title,
	...
	const handleFieldUpdate = async (taskId, data) => {
		...
		setSelectedTask((cur) => cur?.id === taskId ? {
			...cur,
			priority: updated.priority,
			dueDate: updated.dueDate,
			assignee: updated.assignee,
...
//#endregion
//#region src/components/tasks/TaskList.tsx
var GROUPS = [
	{
		status: "BACKLOG",
		label: "Backlog",
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", { children: task.assignee ? /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(Avatar, {
										...
										children: task.assignee.fullName?.split(" ")[0] ?? task.assignee.email
									})]
								}) : /* @__PURE__ */ jsx("span", {
									className: "text-xs text-text-tertiary",
									children: "—"
...
//#endregion
//#region src/components/tasks/TaskFilters.tsx
var STATUS_OPTIONS = [
	{
		value: "BACKLOG",
		label: "Backlog",
...
function TaskFilters({ search, onSearchChange, statusFilter, onStatusChange, priorityFilter, onPriorityChange, assigneeFilter, onAssigneeChange, currentUserId, members }) {
	...
	const assigneeLabel = (() => {
		...
		return members.find((m) => m.user.id === assigneeFilter)?.user.fullName?.split(" ")[0] ?? "User";
	})();
	const statusLabel = (() => {
		...
		children: [
			...
			/* @__PURE__ */ jsxs(FilterPill, {
				...
				children: [
					...
					currentMember && /* @__PURE__ */ jsx(DropdownItem, {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Avatar, {
								...
								children: currentMember.user.fullName ?? currentMember.user.email
							}), /* @__PURE__ */ jsx("span", {
					...
					otherMembers.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(DropdownDivider, {}), otherMembers.map((m) => /* @__PURE__ */ jsx(DropdownItem, {
			...
			/* @__PURE__ */ jsxs(FilterPill, {
				label: statusLabel,
				icon: statusFilter ? /* @__PURE__ */ jsx("span", { className: `h-2 w-2 rounded-full ${STATUS_OPTIONS.find((s) => s.value === statusFilter)?.dot ?? "bg-text-tertiary"}` }) : /* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full border border-current opacity-50" }),
				active: !!statusFilter,
...
//#endregion
//#region src/routes/_authed/projects.$projectId.index.tsx?tsr-split=component
...
function ProjectBoardPage() {
	...
	const [view, setView] = useState(() => {
		if (typeof window !== "undefined") return localStorage.getItem("taskflow-view") ?? "board";
		return "board";
	});
	useEffect(() => {
